...
// Verify if ID is provided and is valid
if (!isset($_GET["id"]) || empty($_GET["id"]) || !is_numeric($_GET["id"])) {
    echo "ID de voyage invalide ou manquant.";
    exit();
}

$id = $_GET["id"];
$voyageC = new voyageC();
$voyage = $voyageC->showVoyage($id);
            ...
            <ul class="list-group">
              <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                <div class="d-flex flex-column">
                  <h2 class="mb-3 text-sm">Détails du voyage : <?= $voyage["id"]; ?></h6>

                  <div class="mb-2 text-xs">ID du voyage :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["id"]; ?></span>
                  </div>

                  <div class="mb-2 text-xs">Destination :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["destination"]; ?></span>
                  </div>

                  <div class="mb-2 text-xs">Description :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["description"]; ?></span>
                  </div>

                  <div class="mb-2 text-xs">Titre :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["titre"]; ?></span>
                  </div>

                  <div class="mb-2 text-xs"> Date Départ :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["date_depart"]; ?></span>
                  </div>

                  <div class="mb-2 text-xs">Date Retour :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["date_retour"]; ?></span>
                  </div>
                  <div class="mb-2 text-xs">Prix / personne  :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["prix"]; ?></span>
                  </div>
                  <div class="mb-2 text-xs">Type :
                    <span class="text-dark font-weight-bold ms-sm-2"><?= $voyage["type"]; ?></span>
                  </div>
                </div>
              </li>
